...
<section class="mt-24">
    <div class="container">
        <div class="flex justify-center w-full">
            <div>
                <form action="/auth/login" method="post" class="w-[400px]">
                ...
                <p class="text-center mt-4">Нет аккаунта? <a href="/auth/sign-up" class="text-blue-500 underline">Создайте его!</a></p>
            </div>
        </div>
    </div>
</section>
